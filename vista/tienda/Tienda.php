	...
	Atributos:[
		...
		},
		{
			config:{
				...
				type:'TextField',
				filters:{pfiltro:'sho.nombre',type:'string'},
				id_grupo:1,
				grid:true,
				form:true
		},
		{
			config:{
				...
				type:'TextField',
				filters:{pfiltro:'sho.estado_reg',type:'string'},
				id_grupo:1,
				grid:true,
				form:false
		},
		{
			config:{
				...
				type:'TextField',
				filters:{pfiltro:'sho.usuario_ai',type:'string'},
				id_grupo:1,
				grid:true,
				form:false
		},
		{
			config:{
				...
				type:'DateField',
				filters:{pfiltro:'sho.fecha_reg',type:'date'},
				id_grupo:1,
				grid:true,
				form:false
		},
		...
		},
		{
			config:{
				...
				type:'Field',
				filters:{pfiltro:'sho.id_usuario_ai',type:'numeric'},
				id_grupo:1,
				grid:false,
				form:false
		},
		{
			config:{
				...
				type:'DateField',
				filters:{pfiltro:'sho.fecha_mod',type:'date'},
				id_grupo:1,
				grid:true,
				form:false
		},
